...
var data = []byte{
	0x01, 0x00, 0x00, 0x01,
	0x01, 0x01, // bmp
	0xa3, 0x35, 0xf7, 0x52, // mac
	0x00, 0x00, // end of prefix (padding) entering `phy_status_t`
	0x00, 0x01, 0x01, 0x01, 0x04, 0x03, // 6 bytes before `freq_hz`
